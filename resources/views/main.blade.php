    ...
    <div class="w3-content w3-padding" style="max-width:1564px">
        ...
        <div class="w3-row-padding">
            <div class="w3-col l3 m6 w3-margin-bottom">
                <div class="w3-display-container">
                    ...
                    <img src="https://jandevents.com/wp-content/uploads/jand-party.jpg" alt="House" width="350px"
                        height="250px">
            ...
            <div class="w3-col l3 m6 w3-margin-bottom">
                <div class="w3-display-container">
                    ...
                    <img src="https://storage.zcanme.com/img/68-event-img2-1609129350.png" alt="House" width="350px"
                        height="250px">
                </div>
            </div>
            <div class="w3-col l3 m6 w3-margin-bottom">
                <div class="w3-display-container">
                    ...
                    <img src="" alt="House" width="350px" height="250px">
                </div>
            </div>
            <div class="w3-col l3 m6 w3-margin-bottom">
                <div class="w3-display-container">
        ...
        <div class="w3-row-padding">
            ...
            <div class="w3-col l3 m6 w3-margin-bottom">
                <div class="w3-display-container">
                    <div class="w3-display-topleft w3-black w3-padding">Blur</div>
                    <img src="https://www.vl.co.th/uploads/portfolio/02-1-2023-05-09portfolio143940.jpg" alt="House"

                        ...
                        <div>
                                ...
                                <div class="w-full px-3 mb-5">
                                    ...
                                    <div class="flex">
                                        ...
                                        <input type="text" id="name" name="name"
                                               class="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="John">
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="w-full px-3 mb-12">
                                    ...
                                    <div class="flex">
                                        ...
                                        <input type="password" id="password" name="password" required autocomplete="current-password"
                                               class="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="************">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="flex -mx-3">
                                <div class="w-full px-3 mb-5">
                                    <a href="{{ route('home') }}">
                                        <button type="submit"
                                             class="block w-full max-w-xs mx-auto bg-indigo-500 hover:bg-indigo-700 focus:bg-indigo-700 text-white rounded-lg px-3 py-3 font-semibold">REGISTER NOW</button>
                                    </a>
                                </div>
                            </div>
                        </div>

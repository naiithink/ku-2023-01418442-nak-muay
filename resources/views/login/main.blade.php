    ...
    <div class="w3-top">
        <div class="w3-bar mint-b w3-wide w3-padding w3-card">
            ...
            <div class="w3-right w3-hide-small">
                ...
                <a href="{{ route('admin-create-staff') }}" class="w3-bar-item w3-button">Create
                    Staff(Admin)</a>
                <a href="{{ route('admin-profile') }}" class="w3-bar-item w3-button">Admin
                    Profile(Admin)</a>
        ...
        <div class="w3-row-padding">
            <div class="w3-col l3 m6 w3-margin-bottom">
                <div class="w3-display-container">
                    ...
                    <a href="{{ route('student-events') }}">
                        <img src="https://jandevents.com/wp-content/uploads/jand-party.jpg" alt="House"
            ...
            <div class="w3-col l3 m6 w3-margin-bottom">
                <div class="w3-display-container">
                    ...
                    <a href="{{ route('student-events') }}">
                        <img src="https://storage.zcanme.com/img/68-event-img2-1609129350.png" alt="House"
                            width="350px" height="250px">
                    </a>
                </div>
            </div>
            ...
            <div class="w3-col l3 m6 w3-margin-bottom">
                <div class="w3-display-container">
                    ...
                    <a href="{{ route('student-events') }}">
                        <img src="https://siam2nite.media/ljfMqgpivLqGlsmSXLIPrIIrOJk=/1280x960/smart/locations/2177/cover_large_p1dp265ru9f0p1gjc7k6ah31e0p9.jpg"
                            alt="House" width="350px" height="250px">
                    </a>
                </div>
            </div>
        </div>
        ...
        <div class="w3-row-padding">
            <div class="w3-col l3 m6 w3-margin-bottom">
                <div class="w3-display-container">
                    ...
                    <img src="https://www.plutoticket.com/cdn-cgi/image/width=440,format=auto/https://storage.plutoticket.com/protected/ap-southeast-1:6dd2cf57-fbf3-4022-94ea-1c1f2be67cce/events/012e96f5-edfd-4e1d-b45c-6d5e0579c335/images/0_1687520681484.jpeg"
                        alt="House" width="350px" height="250px">
                    </a>
                </div>
            </div>
            <div class="w3-col l3 m6 w3-margin-bottom">
                <div class="w3-display-container">
                    ...
                    <a href="{{ route('student-events') }}">
                        <img src="https://obs.line-scdn.net/r/ect/ect/image_16837381851540788156c6a1708t1197f539"
                            alt="House" width="350px" height="250px">
                    </a>
                </div>
            </div>
            ...
            <div class="w3-col l3 m6 w3-margin-bottom">
                <div class="w3-display-container">
                    <div class="w3-display-topleft w3-black w3-padding">Blur</div>
                    <a href="{{ route('student-events') }}">
                        <img src="https://www.vl.co.th/uploads/portfolio/02-1-2023-05-09portfolio143940.jpg"
                            alt="House" width="350px" height="250px">
                    </a>
                </div>
            </div>

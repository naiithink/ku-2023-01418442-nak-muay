...
@section('content')
    ...
    <div class="grid grid-cols-3 gap-20 ml-14 mt-10">
        ...
        @foreach($events as $event)
            ...
            <div class="max-w-sm bg-white border border-teal-300 rounded-lg shadow dark:bg-gray-800 dark:border-teal-300 ">
                <div class="flex items-center justify-center">
    ...
    <div class="w3-container w3-padding-16 text-white" id="about" align="center">
        ...
        <h3 class="w3-padding-16 text-3xl">Group : Nak-Muay</h3>
        <h1 class="w3-padding-16 text-xl">Member</h1>
    </div>

    <div class=" flex item-center justify-evenly w-full" align="center">
        <!-- Au -->
        <div class="flex flex-col justify-center max-w-lg p-10 shadow-md rounded-xl sm:px-12 dark:bg-gray-900 dark:text-gray-100 border border-teal-300 ">
            ...
            <div class="space-y-4 text-center divide-y divide-gray-700">
                <div class="my-2 space-y-1">
                    <h2 class="text-xl font-semibold sm:text-2xl">Au</h2>
                    <p class="px-5 text-xs sm:text-base dark:text-gray-400">Au Love เมีย </p>
                </div>
        ...
        <!-- Ton -->
        <div class="flex flex-col justify-center max-w-xs p-6 shadow-md rounded-xl sm:px-12 dark:bg-gray-900 dark:text-gray-100  border border-teal-300">
            <img src="image/ton.jpg" alt="" class="w-32 h-32 mx-auto rounded-full dark:bg-gray-500 aspect-square">
            <div class="space-y-4 text-center divide-y divide-gray-700">
                <div class="my-2 space-y-1">
                    <h2 class="text-xl font-semibold sm:text-2xl">Ton</h2>
                    <p class="px-5 text-xs sm:text-base dark:text-gray-400">Are you out Yet?</p>
                </div>
                <div class="flex justify-center pt-2 space-x-4 align-center">
                    <a rel="noopener noreferrer" href="#" aria-label="GitHub" class="p-2 rounded-md dark:text-gray-100 hover:dark:text-violet-400">
                        <svg viewBox="0 0 496 512" xmlns="http://www.w3.org/2000/svg" class="w-4 h-4 fill-current">
        ...
        <div class="flex flex-col justify-center max-w-xs p-6 shadow-md rounded-xl sm:px-12 dark:bg-gray-900 dark:text-gray-100  border border-teal-300">
            ...
            <div class="space-y-4 text-center divide-y divide-gray-700">
                <div class="my-2 space-y-1">
                    <h2 class="text-xl font-semibold sm:text-2xl">Nai</h2>
                    <p class="px-5 text-xs sm:text-base dark:text-gray-400">The carry</p>
                </div>
                <div class="flex justify-center pt-2 space-x-4 align-center">
                    <a rel="noopener noreferrer" href="#" aria-label="GitHub" class="p-2 rounded-md dark:text-gray-100 hover:dark:text-violet-400">
                        <svg viewBox="0 0 496 512" xmlns="http://www.w3.org/2000/svg" class="w-4 h-4 fill-current">
    ...
    <div class="w3-container w3-padding-32" id="contact">
        ...
        <h1 class="w3-border-light-grey w3-text-white w3-center text-xl">For sent a message</h1>
